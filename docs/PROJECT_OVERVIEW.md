...
| 语言 | 文件数 | 代码行数 | 占比 |
|------|--------|---------|------|
| **Markdown (文档)** | 166 | 61,196 | 40.1% |
| **TypeScript (业务代码)** | 228 | 44,365 | 29.1% |
| **JSON (配置/数据)** | 18 | 37,959 | 24.9% |
| **JavaScript** | 13 | 4,344 | 2.8% |
| **CSS** | 8 | 2,289 | 1.5% |
| **YAML** | 10 | 1,892 | 1.2% |
| **SQL (数据库)** | 4 | 531 | 0.3% |
...
| 模块 | 文件数 | 代码行数 |
|------|--------|---------|
| **后端 (TypeScript)** | 138 | 30,163 |
| **前端 (TSX/CSS)** | 65 | 13,071 |
| **文档 (Markdown)** | 134 | 51,337 |
| **配置文件** | 11 | 1,902 |
| **数据库 Schema** | 6 | 571 |
...
| 类别 | 文件数 | 代码行数 |
|------|--------|---------|
| TypeScript (后端) | 138 | 30,163 |
| TypeScript (前端) | 57 | 10,782 |
| CSS | 8 | 2,289 |
| JavaScript | 13 | 4,344 |
| Markdown (文档) | 166 | 61,196 |
| JSON | 18 | 37,959 |
| YAML | 10 | 1,892 |
| SQL | 4 | 531 |
| **总计** | **447** | **152,576** |
